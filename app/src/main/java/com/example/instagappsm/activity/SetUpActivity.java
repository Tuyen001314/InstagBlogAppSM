...
public class SetUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileName = findViewById(R.id.edt_name_enter);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()) {
                    if(task.getResult().exists()) {
                        ...
                        Glide.with(SetUpActivity.this).load(imgURL).into(circleImageView);
                                ...
                                if (task.isSuccessful()) {
                                    imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            downloadUri = uri;
                                            saveToFireStore(task, name, downloadUri);
                                        }
                                    });
    ...
    private void saveToFireStore(Task<UploadTask.TaskSnapshot> task, String name, Uri uri) {
